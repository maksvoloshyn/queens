...
- **Keep it Simple:** Write code that is easy to understand at a glance. Avoid "clever" one-liners or complex ternary chains. If a piece of logic requires a comment to explain _what_ it does, it should be refactored to be self-documenting.
